...
STEP_TYPE_WEB_PRESS = "web_press"
STEP_TYPE_WEB_DRAG = "web_drag"
...
ALL_STEP_TYPES = {
    ...
    STEP_TYPE_WEB_GOTO, STEP_TYPE_WEB_CLICK, STEP_TYPE_WEB_PRESS,
    STEP_TYPE_WEB_DRAG, STEP_TYPE_WEB_INPUT,
