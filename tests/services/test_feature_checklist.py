...
def test_one_case_counted_once_across_aspects():
    ...
    res = build_checklist(aspects, _cases("c1"))
    assert res[0]["covered_count"] == 1 and res[0]["covered_case_ids"] == [1]
    assert res[1]["covered_count"] == 0 and res[1]["covered_case_ids"] == []
