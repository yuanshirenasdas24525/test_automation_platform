...
API_CONFIG_SCHEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "type": "str",
        "default": "all",
        "description": "加解密作用范围(配合脚本 crypto.should_apply)：all=全项目开启；include=仅名单内(crypto_modules/crypto_cases)；exclude=名单外。用例变量 rel_crypto=1/0 可对单用例强制开/关，优先级最高。",
        "example": "include",
        "applies_to": ["api"],
    },
    {
        ...
        "type": "json",
        "default": "[]",
        "description": "crypto_scope=include/exclude 时的模块名名单(JSON 数组或逗号串)。命中的模块下所有用例走该策略。",
        "example": '["支付", "结算"]',
        "applies_to": ["api"],
    },
    {
        ...
        "type": "json",
        "default": "[]",
        "description": "crypto_scope=include/exclude 时的用例名或用例 id 名单(JSON 数组或逗号串)。",
        "example": '["支付下单加密用例", 1024]',
        "applies_to": ["api"],
    },
    {
        "config_group": "encryption_decryption",
...
APP_CONFIG_SCHEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "type": "text",
        "default": "",
        "description": "指定运行设备的 udid（多设备时选一台；留空则按设备池自动挑）。",
    ...
    },
    {
        ...
        "type": "text",
        "default": "",
        "description": "设备名（多为显示用；iOS 模拟器用它选目标）。",
        "example": "emulator-5554",
        "applies_to": ["app"],
    },
    {
        ...
        "type": "text",
        "default": "",
        "description": "安装包路径（apk/ipa）。设备上没装被测 App 时用来安装；已预装 + noReset 可留空。",
        "example": "data/app_packages/xxx.apk",
        "applies_to": ["app"],
    },
    {
        "config_group": "launch",
...
WEB_TEST_ACCOUNT_CONFIG_SCHEMA: list[dict[str, Any]] = [
    {
        ...
        "description": (
            ...
            "state ∈ normal/admin/disabled/locked/boundary。password 加密保存、读取时掩码。"
        ),
        "default": [],
        "example": [
